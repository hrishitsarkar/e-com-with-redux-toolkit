...
const Orders = () => {
    ...
    //destructuring orders from selector
    ...
    useEffect(() => {
        setLoading(true);
        setTimeout(() => {
            //getting the order while the page mounts by dispatching async operation
    ...
    return (<div className="h-[90vh] overflow-auto">
        {loading ? <div className="flex items-center justify-center "><BarLoader
            ...
            </div> : <div className=" mb-[100px] w-full  flex flex-col items-center justify-center">
